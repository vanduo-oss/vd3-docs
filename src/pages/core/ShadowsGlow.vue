...
<template>
  <section id="shadows-glow">
    ...
    <p class="vd-mb-8">
      vd3 provides a comprehensive shadow system based on Fibonacci proportions,
      plus glow effects for interactive elements. Shadows create depth and
      visual hierarchy, while glow effects add emphasis on hover.
    </p>
      ...
      <div class="vd-col-12 vd-col-md-6">
        <div class="vd-card vd-card-glow demo-card">
          ...
          <div class="vd-card-body">
            ...
            <div class="vd-d-flex vd-flex-col vd-gap-3">
              <div class="vd-p-3 vd-rounded-md vd-shadow-primary vd-bg-primary">
                <code>.shadow-primary</code>
              </div>
              <div class="vd-p-3 vd-rounded-md vd-shadow-success vd-bg-success">
                <code>.shadow-success</code>
              </div>
              <div class="vd-p-3 vd-rounded-md vd-shadow-warning vd-bg-warning">
                <code>.shadow-warning</code>
              </div>
              <div class="vd-p-3 vd-rounded-md vd-shadow-error vd-bg-error">
